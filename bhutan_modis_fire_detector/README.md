...
```powershell
C:\Users\Public\miniforge3\Scripts\conda.exe run -n modis-hdf python bhutan_modis_fire_detector\main.py --max-observations 2
```

Outputs are written to `bhutan_modis_fire_detector/outputs` by default.
