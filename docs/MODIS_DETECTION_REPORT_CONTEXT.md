...
- `detectors/modis/config.py`
- `detectors/modis/main.py`
- `detectors/modis/src/data_ingestion.py`
- `detectors/modis/src/preprocessing.py`
- `detectors/modis/src/contextual_tests.py`
- `detectors/modis/src/fire_detection.py`
- `detectors/modis/src/context.py`
- `detectors/modis/src/export_outputs.py`
