...
class Paths:
    ...
    viirs: Path = WORKSPACE_ROOT / "data" / "raw" / "viirs" / "historical_detector"
    dem: Path = WORKSPACE_ROOT / "data" / "reference" / "dem"
    lulc: Path = WORKSPACE_ROOT / "data" / "reference" / "lulc"
    buildings: Path = WORKSPACE_ROOT / "data" / "reference" / "buildings"
    vectors: Path = WORKSPACE_ROOT / "data" / "reference" / "vectors"
    outputs: Path = WORKSPACE_ROOT / "outputs" / "viirs_detector"
