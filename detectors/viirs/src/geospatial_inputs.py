...
def find_bhutan_boundary_path(folder: Path) -> Path | None:
    ...
    The project can use either a boundary copied into data/reference/vectors or the
    ...
    workspace_root = folder.parents[2]
    search_roots = [
        folder,
        workspace_root / "data" / "reference" / "boundaries",
        workspace_root / "apps" / "dashboard" / "client" / "public" / "data",
        workspace_root / "apps" / "dashboard" / "server" / "Administrative Boundaries",
    ]
